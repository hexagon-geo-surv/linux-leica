...
static const struct cci_reg_sequence mode_2592x1944_vflip_normal[] = {
	...
	{ CCI_REG8(0x3081), 0x02, }, /* undocumented */
	{ CCI_REG8(0x3083), 0x02, }, /* undocumented */
	{ CCI_REG16_LE(0x30b6), 0x00 }, /* undocumented */
	{ CCI_REG16_LE(0x3116), 0x08 }, /* undocumented */
};

static const struct cci_reg_sequence mode_2592x1944_vflip_inverted[] = {
	{ IMX335_REG_AREA3_ST_ADR_1, 4112 },
	{ CCI_REG8(0x3081), 0xfe, }, /* undocumented */
	{ CCI_REG8(0x3083), 0xfe, }, /* undocumented */
	{ CCI_REG16_LE(0x30b6), 0x1fa }, /* undocumented */
	{ CCI_REG16_LE(0x3116), 0x002 }, /* undocumented */
};
