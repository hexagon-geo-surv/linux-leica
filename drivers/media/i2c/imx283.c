...
static const struct imx283_mode supported_modes_12bit[] = {
	...
	{
		/* 2/2 Binned Panoramic Mode 2736x450: readout mode 2 */
		.scan = &imx283_scan_modes[IMX283_MODE_2],
		.width = 2736,
		.height = 450,
		.min_hmax = 5914, /* 887 @ 480MHz/72MHz */
		...
		.crop = CENTERED_RECTANGLE(imx283_recommended_area, 5472, 900, 6),
	},
	{
	...
	{
		/* Custom Crop Mode 4096x3072: readout mode 0 */
		.scan = &imx283_scan_modes[IMX283_MODE_0],
		.width = 4096,
		.height = 3072,
		.min_hmax = 5014, /* 752 @ 480MHz/72MHz */
		...
		.crop = CENTERED_RECTANGLE(imx283_recommended_area, 4096, 3072, 6),
	},
	{
		/* Custom Crop Mode 2304x3072: readout mode 0 */
		.scan = &imx283_scan_modes[IMX283_MODE_0],
		.width = 2304,
		.height = 3072,
		.min_hmax = 5914, /* 887 @ 480MHz/72MHz */
		...
		.crop = CENTERED_RECTANGLE(imx283_recommended_area, 2304, 3072, 6),
	},
	/* HOB for Calibration only */
	{
		/* HOB 48x3694: readout mode 0 */
		.scan = &imx283_scan_modes[IMX283_MODE_0],
		.width = 48,
		.height = 3694,
		.min_hmax = 5914, /* 887 @ 480MHz/72MHz */
				  ...
				  u64 streams_mask)
{
	...
	cci_write(imx283->cci, IMX283_REG_XMSTA, IMX283_XMSTA, &ret);
