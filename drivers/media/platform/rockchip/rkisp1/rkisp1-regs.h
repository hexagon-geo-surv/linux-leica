...
#define RKISP1_CIF_ISP_COMPAND_EXPAND_PX(n)	(RKISP1_CIF_ISP_COMPAND_BASE + 0x00000014 + (n) * 4)
#define RKISP1_CIF_ISP_COMPAND_COMPRESS_PX(n)	(RKISP1_CIF_ISP_COMPAND_BASE + 0x00000040 + (n) * 4)
